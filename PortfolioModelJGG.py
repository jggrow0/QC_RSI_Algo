...
class PortfolioModelJGG(PortfolioConstructionModel):
    ...
    def CreateTargets(self, algorithm, insightList):
        ...
        for insight in insightList:
            dollarRisk = 100
            insightTarget = PortfolioTarget(insight.Symbol,(insight.Direction if self.RespectPortfolioBias(insight) else InsightDirection.Flat)*dollarRisk/insight.Magnitude)
